...
class InstanceTest {
    ...
    void calcCost() {
        ...
        assertEquals(4 + 3, instance.calcCost(3));
        assertEquals(0 + 4, instance.calcCost(1));
        assertEquals(3 + 8, instance.calcCost(0));
        ...
        assertEquals( 0 + 8, correctInstance.calcCost(1));
